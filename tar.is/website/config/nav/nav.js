window.onload = function buildNav(){
    ...
    document.querySelector("header").innerHTML += `
        <div id='menuOverlay' class='menuOverlay'>
            ...
            <a href='/tar.is/website/hugbunadur/hugbunadur.html' class='hugbunadur'>Námskeið</a>
            <a href='/tar.is/website/umOkkur/umOkkur.html' class='umOkkur'>Starfsemi</a>
            <a href='/tar.is/website/hafaSamband/hafaSamband.html' class='hafaSamband'>Hafðu samband</a>
        </div>
    `
    ...
    function navHighlight(){
        ...
        if(url == '/tar.is/website/'){
            heim.style.textShadow = '1px 1px black';
        }
        if(url == '/tar.is/website/hugbunadur/hugbunadur.html'){
            hugbunadur.style.textShadow = '1px 1px black';
        }
        if(url == '/tar.is/website/umOkkur/umOkkur.html'){
            umOkkur.style.textShadow = '1px 1px black';
        }
        if(url == '/tar.is/website/hafaSamband/hafaSamband.html'){
            hafaSamband.style.textShadow = '1px 1px black';
        }
    }
    navHighlight();
}